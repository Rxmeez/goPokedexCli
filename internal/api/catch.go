...
import (
	...
	"github.com/rxmeez/goPokedexCli/internal/pokestore"
)
...
func (p *Pokemon) catch(body []byte, pokemon string) error {
	...
	difficulty := p.BaseExperience / 10
